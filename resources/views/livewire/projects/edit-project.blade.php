                            ...
                            <div class="border-b border-gray-900/10 pb-12 pt-5">
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input wire:model="name" id="project-name" name="project-name" value="{{ $name }}" type="text" autocomplete="project-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                            @error('name')
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="employees" class="block text-sm font-medium leading-6 text-gray-900">Status</label>
                                        <div class="mt-2">
                                            <select wire:model="status" name="employee" id="employee" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="project-manager" class="block text-sm font-medium leading-6 text-gray-900">Project Manager</label>
                                        <div class="mt-2">
