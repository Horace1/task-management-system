                    ...
                    <div class="border-t border-gray-100">
                        <dl class="divide-y divide-gray-100">
                            ...
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $task->formatted_start_date }}</dd>
                            </div>
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-900">End Date</dt>
                                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $task->formatted_end_date }}</dd>
                            </div>
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <div class="px-4 py-6 flex">
                                <a href="{{ route('view-tasks') }}" wire:navigate type="button" class="text-sm font-semibold leading-6 text-gray-900 ml-auto">
